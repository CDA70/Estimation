...
VehicleCommand QuadControl::GenerateMotorCommands(float collThrustCmd, V3F momentCmd)
{
  ...
  ////////////////////////////// BEGIN STUDENT CODE ///////////////////////////
    ...
    // added 4.f after review code
    float thrust_z = -momentCmd.z / 4.f /  kappa; // kappa = torque (Nm) produced by motor per N of thrust produced
